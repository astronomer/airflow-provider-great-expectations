...
class TestSnowflakeConnectionString:
    ...
    @patch(
        "great_expectations_provider.common.external_connections._build_snowflake_connection_string_from_hook"
    )
    ...
    @patch(
        "great_expectations_provider.common.external_connections._build_snowflake_connection_string_manual"
    )
...
class TestSnowflakeKeyConnection:
    ...
    @patch(
        "great_expectations_provider.common.external_connections._build_snowflake_key_connection_from_hook"
    )
